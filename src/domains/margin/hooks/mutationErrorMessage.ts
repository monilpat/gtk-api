export const ACCOUNT_NOT_APPROVED_FOR_TRADING =
  'Your account has not yet been approved for margin trading.'
export const ACCOUNT_NOT_ENOUGH_BALANCE =
  'You dont have enough balance of the required coin.'
...
export const DEFAULT_ERROR_CLOSE_POSITION =
  'Failed to close margin position. Try again later.'
export const DEFAULT_ERROR_OPEN_POSITION =
  'Failed to open margin position. Try again later.'
...
export const POOL_TRADE_TEMPORARILY_DISABLED =
  'Margin trading is temporarily disabled for this pool.'

export const MTP_NOT_FOUND =
  'Unable to close the trade position. Trade ID not found.'
...
export const SIFNODE_ERRORS = {
  ...
  MTP_HEALTH_ABOVE_FORCE_CLOSE_THRESHOLD:
    'mtp health above force close threshold',
  ...
  BORROWED_AMOUNT_IS_HIGHER_THAN_POOL_DEPTH:
    'borrowed amount is higher than pool depth',
  CUSTODY_AMOUNT_IS_HIGHER_THAN_POOL_DEPTH:
    'custody amount is higher than pool depth',
  MTP_HEALTH_WOULD_BE_TOO_LOW_FOR_SAFETY_FACTOR:
